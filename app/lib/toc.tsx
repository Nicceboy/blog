...
export function TableOfContents() {
  ...
  return (
    <nav className="block w-full mb-6 lg:float-right lg:ml-8 lg:mb-8 lg:w-64 max-h-[calc(100vh-8rem)] overflow-auto p-3 border border-gray-700 rounded-lg transition-all duration-300 ">
      {headings.length > 0
        ? (
          <>
              ...
              {headings.map((heading, i) => (
                ...
                >
                  <a
                    ...
                    className="text-lg text-red-my font-bold hover:text-red-my-hover hover:underline"
                  >
                    {heading.text}
                  </a>
                </li>
